...
const _BOX_TEXTURE_PINK : Texture2D = preload("res://assets/geometry/burnable_block_8_pink.png")
const _BOX_TEXTURE_BLUE : Texture2D = preload("res://assets/geometry/burnable_block_8_blue.png")
const _BOX_TEXTURE_GREEN : Texture2D = preload("res://assets/geometry/burnable_block_8_green.png")
const _BOX_TEXTURE_RED : Texture2D = preload("res://assets/geometry/burnable_block_8_red.png")

# Intentionally swapped colors for more visual clarity.
const _BOX_TEXTURE_DICT : Dictionary[Colors, Texture2D] = {
	Colors.PINK: _BOX_TEXTURE_GREEN, 
	Colors.BLUE: _BOX_TEXTURE_RED,
	Colors.GREEN: _BOX_TEXTURE_PINK,
	Colors.RED: _BOX_TEXTURE_BLUE,
}
